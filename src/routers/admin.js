    ...
    try {
        ...
        try {
            ...
            const mailOptions = {
                ...
                text: `Your username and password are ${voter.username} and ${password} respectively. 
                The credentials shall be valid only for the next 10 minutes. In case of any queries, contact
